  ...
  return (
    <div className="herohero herobg">
      ...
      >
        ...
        <div className="hero-content">{/* Add your hero content here */}</div>
      </div>
      ...
      <section className="showcase ">
        ...
        <div className="texty">
          ...
          <p>
            Explore our carefully chosen collection of high-quality fabrics that
            can spark your creativity and enhance your sense of fashion.
          </p>
