  ...
  return (
    <div className="parentship">
      ...
      <div className="contntainerz contntaineroc">
        <div id="logogo">
          <h1 className="h1class logogo">BECCA</h1>
          <div className="CTA">
        ...
        <div className="rightboxz">
          <div className="settings ">
            {/* <h1 className="">Shipping info of order id # {order._id}</h1> */}
            <h2 className="h2class">Name : {user && user.name}</h2>
            <h2 className="h2class">Phone : {shippingInfo && shippingInfo.phoneNo}</h2>
